...
const struct v4l2_file_operations fimc_is_3a1_video_fops;
const struct v4l2_ioctl_ops fimc_is_3a1_video_ioctl_ops;
const struct vb2_ops fimc_is_3a1_qops;
...
static int fimc_is_3a1_video_close(struct file *file)
{
	...
	fimc_is_ischain_3a1_close(device, vctx);
...
static unsigned int fimc_is_3a1_video_poll(struct file *file,
...
static int fimc_is_3a1_video_mmap(struct file *file,
...
const struct v4l2_file_operations fimc_is_3a1_video_fops = {
	.owner		= THIS_MODULE,
	.open		= fimc_is_3a1_video_open,
	.release	= fimc_is_3a1_video_close,
	.poll		= fimc_is_3a1_video_poll,
	.unlocked_ioctl	= video_ioctl2,
	.mmap		= fimc_is_3a1_video_mmap,
};
...
static int fimc_is_3a1_video_querycap(struct file *file, void *fh,
...
static int fimc_is_3a1_video_enum_fmt_mplane(struct file *file, void *priv,
...
static int fimc_is_3a1_video_get_format_mplane(struct file *file, void *fh,
...
static int fimc_is_3a1_video_cropcap(struct file *file, void *fh,
...
static int fimc_is_3a1_video_get_crop(struct file *file, void *fh,
...
static int fimc_is_3a1_video_querybuf(struct file *file, void *priv,
...
static int fimc_is_3a1_video_qbuf(struct file *file, void *priv,
	struct v4l2_buffer *buf)
{
	int ret = 0;
	struct fimc_is_video_ctx *vctx = file->private_data;
...
static int fimc_is_3a1_video_streamon(struct file *file, void *priv,
...
static int fimc_is_3a1_video_streamoff(struct file *file, void *priv,
	enum v4l2_buf_type type)
{
	int ret = 0;
	struct fimc_is_video_ctx *vctx = file->private_data;
...
static int fimc_is_3a1_video_enum_input(struct file *file, void *priv,
...
static int fimc_is_3a1_video_g_input(struct file *file, void *priv,
	unsigned int *input)
{
...
static int fimc_is_3a1_video_s_ctrl(struct file *file, void *priv,
...
static int fimc_is_3a1_video_g_ctrl(struct file *file, void *priv,
	struct v4l2_control *ctrl)
{
...
static int fimc_is_3a1_video_g_ext_ctrl(struct file *file, void *priv,
...
const struct v4l2_ioctl_ops fimc_is_3a1_video_ioctl_ops = {
	.vidioc_querycap		= fimc_is_3a1_video_querycap,

	.vidioc_enum_fmt_vid_out_mplane	= fimc_is_3a1_video_enum_fmt_mplane,
	.vidioc_enum_fmt_vid_cap_mplane	= fimc_is_3a1_video_enum_fmt_mplane,

	.vidioc_g_fmt_vid_out_mplane	= fimc_is_3a1_video_get_format_mplane,
	.vidioc_g_fmt_vid_cap_mplane	= fimc_is_3a1_video_get_format_mplane,

	.vidioc_s_fmt_vid_out_mplane	= fimc_is_3a1_video_set_format_mplane,
	.vidioc_s_fmt_vid_cap_mplane	= fimc_is_3a1_video_set_format_mplane,

	.vidioc_querybuf		= fimc_is_3a1_video_querybuf,
	.vidioc_reqbufs			= fimc_is_3a1_video_reqbufs,

	.vidioc_qbuf			= fimc_is_3a1_video_qbuf,
	.vidioc_dqbuf			= fimc_is_3a1_video_dqbuf,

	.vidioc_streamon		= fimc_is_3a1_video_streamon,
	.vidioc_streamoff		= fimc_is_3a1_video_streamoff,

	.vidioc_enum_input		= fimc_is_3a1_video_enum_input,
	.vidioc_g_input			= fimc_is_3a1_video_g_input,
	.vidioc_s_input			= fimc_is_3a1_video_s_input,

	.vidioc_s_ctrl			= fimc_is_3a1_video_s_ctrl,
	.vidioc_g_ctrl			= fimc_is_3a1_video_g_ctrl,
	.vidioc_g_ext_ctrls		= fimc_is_3a1_video_g_ext_ctrl,

	.vidioc_cropcap			= fimc_is_3a1_video_cropcap,
	.vidioc_g_crop			= fimc_is_3a1_video_get_crop,
	.vidioc_s_crop			= fimc_is_3a1_video_set_crop,
};
...
static int fimc_is_3a1_buffer_prepare(struct vb2_buffer *vb)
{
	return 0;
}

static inline void fimc_is_3a1_wait_prepare(struct vb2_queue *vbq)
{
	fimc_is_queue_wait_prepare(vbq);
}

static inline void fimc_is_3a1_wait_finish(struct vb2_queue *vbq)
{
...
const struct vb2_ops fimc_is_3a1_qops = {
	.queue_setup		= fimc_is_3a1_queue_setup,
	.buf_prepare		= fimc_is_3a1_buffer_prepare,
	.buf_queue		= fimc_is_3a1_buffer_queue,
	.buf_finish		= fimc_is_3a1_buffer_finish,
	.wait_prepare		= fimc_is_3a1_wait_prepare,
	.wait_finish		= fimc_is_3a1_wait_finish,
	.start_streaming	= fimc_is_3a1_start_streaming,
	.stop_streaming		= fimc_is_3a1_stop_streaming,
};
