/* linux/drivers/media/video/exynos/jpeg_hx/jpeg_hx_dec.c
 *
...
static int jpeg_dec_vidioc_enum_fmt(struct file *file, void *priv,
...
static int jpeg_dec_vidioc_g_fmt(struct file *file, void *priv,
			...
			struct v4l2_format *f)
{
	...
	ctx->param.dec_param.size = pix->plane_fmt[0].sizeimage;
