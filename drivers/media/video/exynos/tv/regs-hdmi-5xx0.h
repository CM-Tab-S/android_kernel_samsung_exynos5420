...
#define HDMI_PHY_BASE(x)		((x) + 0x00000000)
...
/* HDMI PHY registers */
#define HDMI_PHY_REG00		HDMI_PHY_BASE(0x000)
#define HDMI_PHY_REG7C		HDMI_PHY_BASE(0x07C)
...
#define HDMI_PX_LMT_CTRL_YCBCR			(2 << 5)
#define HDMI_PX_LMT_CTRL_RESERVED		(3 << 5)
#define HDMI_PX_LMT_CTRL(x)			(((x) & 0x3) << 5)
...
#define HDMI_AUI_DATA_SF_32			(0x1 << 2)
...
/* HDMI_PHY_REG7C */
#define HDMI_PHY_MODE_SET_DONE			(1 << 7)
